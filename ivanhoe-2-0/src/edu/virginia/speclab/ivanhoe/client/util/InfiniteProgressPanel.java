 ...
 *
 * @author Romain Guy <romain.guy@jext.org>
 * @version 1.0
 *
 * http://jroller.com/page/gfx/20050216#wait_with_style_updated
 */
...
public class InfiniteProgressPanel extends JComponent implements MouseListener
{
    ...
    /** delay before the progress indicator is shown */
    protected int     startDelay = 500;
    ...
    /**
     * Constructor to designate just the delay before the progress bar appears
     * @param startDelay miliseconds before showing the progress bar
     * 
     * TODO - implement a means of the delay, this is a place holder
     */
    public InfiniteProgressPanel(int startDelay)
    {
        this("", 14, 0.70f, 15.0f, 300, startDelay);
    }
    ...
    {
        this(text, barsCount, shield, fps, rampDelay, 500);
    }
    
    public InfiniteProgressPanel(String text, int barsCount, float shield, float fps, int rampDelay, int startDelay)
    {
        this.text       = text;
        ...
        this.startDelay = startDelay > 0 ? startDelay : 500;
    ...
    /**
     * Dummy method to test progress indicator
     */
    public void wasteSomeTime(Component c, int time) 
    {
        try {
            Thread.sleep(time);
